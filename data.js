// ══════════════════════════════════════════════════════════════
//  DATA · PAC BC3 · Piloter un projet digital au service d'un commanditaire
//  E3. Pilotage d'un projet digital · Opération Pulse — Refonte de la plateforme client Lumio Health
//  Reconstruit depuis spec.json (E3) — schéma canonique LUMIO_DATA v3.
//  ⚠️  Placeholders {{PRENOM}} {{NOM}} {{EMAIL_ETUDIANT}} substitués à la connexion.
// ══════════════════════════════════════════════════════════════

window.LUMIO_DATA = {
  "student": {
    "name": "{{PRENOM}} {{NOM}}",
    "role": "Consultant·e externe — pilotage de projet",
  ...
  "mailbox": [
    {
      ...
      "fromEmail": "contact@lumio-health.fr",
  ...
  "guide": {
    ...
    "intro": "Ce guide est là si tu te sens bloqué. Il ne donne pas les réponses : il rappelle ce que le jury attend et comment t'organiser.",
    "sections": [
      {
        "h": "Ta mission",
        "p": "Remettre le projet Pulse sur les rails, arbitrer les tensions techniques et organisationnelles, garantir une livraison conforme aux exigences fonctionnelles, ergonomiques et d'accessibilité, et maintenir la cohésion d'une équipe sous pression dans un calendrier non négociable."
      },
      {
        "h": "Le livrable attendu",
        "p": "Dossier de pilotage projet rédigé collectivement (production écrite) + présentation orale individuelle devant le jury. Le dossier inclut : note de cadrage méthodologique, plan de communication, tableau de bord de suivi, compte rendu de COPIL, plan de tests, matrice des responsabilités (RACI), bilan de performance équipe. La présentation orale dure 20 minutes + 10 minutes de questions jury."
      }
    ]
  },
  "notepad": {
  ...
  "trash": {
    "items": [
      {
        "name": "planning_v1_optimiste.mpp",
        "icon": "📊",
        "size": "1,2 Mo",
        "date": "6 sept.",
        "isEgg": false
    ...
    "egg": {
      ...
      "messages": [
        {
          "from": "yassine",
          "text": "Camille je peux te parler 2 min en off ? c'est pas pour le projet… enfin si mais pas officiellement",
          "time": "22:51"
        },
        {
          "from": "camille",
          "text": "vas-y, qu'est-ce qui se passe",
          "time": "22:52"
        },
        {
          "from": "yassine",
          "text": "j'étais encore au bureau tout à l'heure, Théo était au tel dans la salle Kinetic, porte entrouverte",
          "time": "22:53"
        },
        {
          "from": "yassine",
          "text": "il a dit que si le retard dépasse 10 jours il retire le pilotage à Sonia et le file direct à Jakob",
          "time": "22:54"
        },
        {
          "from": "camille",
          "text": "… tu es sûr de ce que tu as entendu ?",
          "time": "22:56"
        },
        {
          "from": "yassine",
          "text": "sûr. et Sonia est pas au courant. elle se défonce sur ce projet Camille",
          "time": "22:57"
        },
        {
          "from": "camille",
          "text": "putain. je suis mal placée pour ça, je bosse avec Northgate toutes les semaines",
          "time": "22:59"
        },
        {
          "from": "camille",
          "text": "laisse-moi réfléchir. ne dis rien à personne pour l'instant. surtout pas à Sonia, pas comme ça",
          "time": "23:01"
        },
        {
          "from": "yassine",
          "text": "c'est bien pour ça que je t'en parle à toi et pas à elle. je savais pas quoi faire de cette info",
          "time": "23:02"
        }
      ]
    }
...
window.PAC_CONFIG = {
  ...
  "dispositif": "PAC",
  "accroche": "Opération Pulse — Refonte de la plateforme client Lumio Health",
